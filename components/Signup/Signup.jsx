  ...
  <div classname="flex">
      ...
      <main className="relative h-[calc(100vh_-_245px)] sm:h-[calc(100vh_-_209px)] md:h-[calc(100vh_-_241px)] lg:h-[calc(100vh_-_257px)] ">
        <div className="bg-gray-800 h-full flex text-sm sm:text-xl overflow-scroll scroll-smooth ">
          <div className="w-full mx-3 md:max-w-xl  md:mx-auto md:border-gray-700 md:px-3 md:pb-10 my-auto md:rounded-lg mb-6">
            <div className="flex justify-center h-20 my-6 " >
              <AASTLogo width='70' height='70' fill={'#d1d5db'} className='self-center' />
              <h1 className="text-gray-50  text-4xl self-center" ><span className="opacity-30" >|</span> Sign up</h1>
            </div>

            <form>
              <div >
                <div className="text-sm font-bold text-gray-300 tracking-wide">Email Address</div>
                <input className="bg-gray-800 w-full text-white text-md py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type='email' placeholder="abdelrahman.essawy@studentaast.edu" required/>
              </div>

              <div>
                <div className="mt-8 text-sm font-bold text-gray-300 tracking-wide">Registration Number</div>
                <input className="bg-gray-800 w-full text-white text-md py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500 overflow-hidden" type='number' placeholder="20103366" required/>
              </div>
              <div className="mt-8">
                <div className="flex justify-between items-center">
                ...
                <input className="bg-gray-800 w-full text-white text-md py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type='password' placeholder="Enter your password" required />
              </div>
              <div className="mt-8">
                <div className="flex justify-between items-center">
                  <div className="text-sm font-bold text-gray-300 tracking-wide">
                ...
                <input className="bg-gray-800 w-full text-white text-md py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type='password' placeholder="Repeat your password" required/>
              </div>
              <div className="mt-12">
                <Link href='/' >
              ...
              <div className="flex justify-center mt-4 mx-auto text-sm font-display font-semibold text-gray-400 text-start">
                Already have an account ? <Link href={'/login'}>
                  <a className="cursor-pointer mx-2 text-indigo-600 hover:text-indigo-800">Login</a>
                </Link>
              </div>
            </form>
