...
export default function AlertBadge() {
    const gitHubIcon =
        <span id='AlertBadge' className="animate-pulse flex rounded-full bg-indigo-500 uppercase px-2 py-1 text-xs font-bold mr-3">
            <svg className='' height="20" aria-hidden="true" viewBox="0 0 16 16" version="1.1" width="20" data-view-component="true">
